Скрипт получения через API основной информации о кассовых аппаратах через ОФД Такском (Taxcom), для занесения данных в SQL таблицу и использования этих данных на своем сайте. <br />
